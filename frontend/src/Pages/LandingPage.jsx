...
import {
  ...
  Sparkles, Brain, FileText, BarChart3, Calendar,
  Upload, Star, ChevronDown, Play, Menu, X, GraduationCap,
  Layers, Clock, Target, TrendingUp, MessageSquare, Sun, Moon
} from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-[#060812] text-gray-800 dark:text-white font-sans overflow-x-hidden transition-colors duration-300">
      ...
      >
        <div className="max-w-7xl mx-auto px-5 sm:px-8 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm text-gray-600 dark:text-slate-400 font-medium">
            {['Features', 'How it Works', 'Community', 'Pricing'].map(item => (
              <a key={item} href={`#${item.toLowerCase().replace(/ /g, '-')}`} className="hover:text-gray-900 dark:hover:text-white transition-colors">{item}</a>
            ))}
          </div>
        ...
        <AnimatePresence>
          {menuOpen && (
            ...
            >
              {['Features', 'How it Works', 'Community', 'Pricing'].map(item => (
                <a key={item} href="#" className="text-gray-700 dark:text-slate-300 hover:text-gray-900 dark:hover:text-white text-sm font-medium" onClick={() => setMenuOpen(false)}>{item}</a>
              ))}
              <Link to="/login" className="mt-2 px-4 py-2.5 bg-violet-600 text-white text-sm font-bold rounded-lg text-center">
                Get Started Free
              </Link>
            </motion.div>
          )}
        ...
        <motion.div style={{ y: heroY, opacity: heroOpacity }} className="w-full max-w-4xl mx-auto">
          ...
          >
            ...
            <motion.div
              ...
              className="absolute -left-6 top-1/3 bg-white dark:bg-[#0e1428] border border-gray-200 dark:border-white/10 rounded-xl px-3 py-2 shadow-xl flex items-center gap-2 hidden md:flex"
            >
        ...
        <div className="max-w-6xl mx-auto">
          <Reveal className="text-center mb-14">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight mb-4 text-gray-900 dark:text-white">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-500 to-cyan-500 dark:from-violet-400 dark:to-cyan-400">ace your exams</span>
            </h2>
          ...
          <div>
            <Reveal>
              ...
              <h2 className="text-3xl sm:text-4xl font-black tracking-tight mb-4 text-gray-900 dark:text-white">
                From upload to study-ready{' '}
                <span className="text-violet-500 dark:text-violet-400">in 30 seconds</span>
              </h2>
      ...
      <section className="relative z-10 py-20 px-5">
        <div className="max-w-6xl mx-auto">
          <Reveal className="text-center mb-14">
            <h2 className="text-3xl sm:text-4xl font-black tracking-tight mb-2 text-gray-900 dark:text-white">
              Students love AcadBuddy
            </h2>
